    ...
    <div className="projcects-container">
      <div className="card">
        ...
        <p className="project-description">
          A responsive website that lets you browse through a wide range of food
          items with ease.
      ...
      <div className="card">
        ...
        <p className="project-description">
          ...
          <br /> ● Intuitive search results with HTML list elements, styled with
          CSS, Bootstrap, and responsive design for a seamless user experience.
      ...
      <div className="card">
        ...
        <p className="project-description">
          Implemented BookHub where users can log in and can see a list of books
          with search by Book title,filters,etc <br />● Implemented different
          pages like Login, Home, BookShelves, Book item details using React
          ...
          Switch, Link.
          <br /> ● Implemented filters and search text by sending them as query
          parameters to Books API calls.
          <br /> ● Redirecting to the login page if the user tries to open Home,
          Bookshelve, Book item details routes which need authentication by
        ...
        <div className="login">
          ...
          <span className="password-text">Username:rahul</span>
          <span className="password-text">Password:rahul@2021</span>
        </div>
        <a
          className="hyper-link"
          href="https://vijybookhub.netlify.app/"
          rel="noreferrer"
          target="_blank"
        >
          {"->"}Project Link
      ...
      <div className="card">
        ...
        <p className="project-description">
          ...
          lists, event handlers, form inputs. Authenticating by taking username,
          password and doing login post HTTP API Call.
          <br /> ● Persisted user login state by keeping jwt token in client
          storage, Sending it in headers of further API calls to authorize the
          user.
          <br /> ● Implemented different routes for Login, Home, Jobs, Job item
          details pages by using React Router components Route, Switch, Link.
          <br /> ● Implemented filters and search text by sending them as query
